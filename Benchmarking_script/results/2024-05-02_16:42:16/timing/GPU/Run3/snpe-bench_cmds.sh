...
rm -rf output
/data/matt/impact_data/artifacts/aarch64-oe-linux-gcc8.2/bin/snpe-net-run --container mars_detection.dlc --input_list input_list_raw.txt --output_dir output --use_gpu --perf_profile high_performance --profiling_level basic
